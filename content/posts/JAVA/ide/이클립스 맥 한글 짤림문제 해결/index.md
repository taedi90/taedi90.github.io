...
![이클립스 한글 짤림.gif](images/pic-0001.gif)
...
![스크린샷 2021-10-16 오전 7.29.43.png](images/pic-0002.png)
...
![Complex modifications 설정.gif](images/pic-0003.gif)

마우스 관련 옵션을 사용하기 위해서는 아래 두가지 설정이 더 필요하다.

Karabiner-Elements Preferences > Devices 에서 사용하는 마우스가 체크 되어있는지 확인해야한다.

![스크린샷 2021-09-24 오후 11.30.56.png](images/pic-0004.png)

오른쪽 커맨드 버튼을 한영 전환 키로 사용할 경우에는 시스템 환경설정에 단축키를 아래와 같이 변경한다.

![스크린샷 2021-10-16 오전 11.50.53.png](images/pic-0005.png)
